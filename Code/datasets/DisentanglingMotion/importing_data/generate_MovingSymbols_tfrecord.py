...
FLG.output_directory = '/netscratch/arenas/tfrecords/MovingSymbols2-same-tf-records/test'  # Output data directory.
FLG.videos_directory = os.path.join(storage_path, 'output/MovingSymbols2_same/test')       # Video dataset directory.
