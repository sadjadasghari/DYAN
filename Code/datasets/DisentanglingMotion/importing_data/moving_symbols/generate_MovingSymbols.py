...
FLG.dataset_output = 'output/MovingSymbols2_same_4px'               # Directory in which the generated dataset is stored.
...
FLG.train_speed = (4, 4)             # Value ranges of the #pixels the object is displaced between frames.,originally (8,8)
...
FLG.test_labels = [0, 3]
FLG.test_size = (1, 1)
FLG.test_speed = (4, 4) # originally (8,8)
